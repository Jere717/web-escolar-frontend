...
// Obtener el post
$post = isset($_GET['id']) ? obtenerPost($_GET['id'], 'tb_posts') : null;
...
<head>
    ...
    <?php if ($post): ?>
        ...
        <meta property="og:title" content='Publicacion de la cooperadora: "<?php echo $post["title"]; ?>" - Escuela 717'>
        ...
        <meta property="og:url" content="<?php echo BASE_URL ?>/nuestra-comunidad/cooperadora/blog/publicacion.php?="<?php echo $_GET['id']; ?>>
    ...
    <header class="header">
        ...
        <div class="grupo-1">
            ...
            <div class="btn">
                ...
                <a href="<?php echo BASE_URL ?>/nuestra-comunidad/cooperadora/blog/" class="btn-cont" rel="noreferrer noopener">
