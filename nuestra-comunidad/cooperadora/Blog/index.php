...
<head>
    ...
    <title> Agrotecnica 717 + Blog Cooperadora </title>

    <!-- Título de la página compartida -->
    <meta property="og:title" content="Blog Cooperadora - Escuela 717">
    ...
    <meta property="og:url" content="<?php echo BASE_URL ?>/nuestra-comunidad/cooperadora/blog/">
    ...
    <link rel="stylesheet" href="cooperadora.css">
...
<body class="grid-container">
    ...
    <div class="grupo-1">
        ...
        <div class="btn">
            ...
            <a href="<?php echo BASE_URL ?>/nuestra-comunidad/cooperadora/" class="btn-cont" rel="noreferrer noopener">
            ...
            <form id="formulario-buscador" method="GET" action="">
                ...
                <div class="input-group mb-3">
                    <select class="form-select" name="category" onchange="this.form.submit()">
                        ...
                        <?php
                        // Obtener todas las categorías únicas desde la tabla tb_posts
                        $sql = "SELECT DISTINCT category FROM tb_posts";
                        $stmt = $pdo->query($sql);
