...
<head>
    ...
    <title> Agrotecnica 717 + Blog Novedades </title>

    <!-- Título de la página compartida -->
    <meta property="og:title" content="Blog Novedades - Escuela 717">
    ...
    <meta property="og:url" content="<?php echo BASE_URL ?>/nuestra-comunidad/novedades/blog/">
            ...
            <form id="formulario-buscador" method="GET" action="">
                ...
                <div class="input-group mb-3">
                    <select class="form-select" name="category" onchange="this.form.submit()">
                        ...
                        <?php
                        // Obtener todas las categorías únicas desde la tabla tb_posts_blog_escuela
                        $sql = "SELECT DISTINCT category FROM tb_posts_blog_escuela";
                        $stmt = $pdo->query($sql);
